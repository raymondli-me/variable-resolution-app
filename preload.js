...
contextBridge.exposeInMainWorld('api', {
  ...
  pdf: {
    ...
    countAIRatingsForPDF: (params) => ipcRenderer.invoke('pdf:countAIRatingsForPDF', params),
    countHumanRatingsForPDF: (params) => ipcRenderer.invoke('pdf:countHumanRatingsForPDF', params),
